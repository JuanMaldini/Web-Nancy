...
export default function Faq() {
  ...
  const renderFaqItems = () => {
    const faqKeys = Object.keys(faqsData)
    const faqItems = []
        ...
        faqItems.push(
          <div className="mb-3" key={i}>
            ...
            >
              ...
              >
                <span className="text-[15px] text-gray-800">{faqsData[questionKey]}</span>
