...
export default function Product({
  ...
  // Helper function
  const getWhatsappContactProduct = (label: string) => {
  ...
  return (
    <div className="w-[220px] sm:w-[240px] md:w-[260px] lg:w-[280px] xl:w-[300px] flex flex-col rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.01] bg-white cardGeneral">
      <Carousel
        images={images}
