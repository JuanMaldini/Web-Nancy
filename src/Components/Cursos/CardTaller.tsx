...
export default function CardTaller({
  ...
  return (
    <div
      className="w-[350px] sm:w-[450px] md:w-[650px] lg:w-[750px] xl:w-[850px] grid grid-cols-[1fr_1.7fr] h-auto rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] bg-white cardGeneral"
      onClick={onClick}
    >
